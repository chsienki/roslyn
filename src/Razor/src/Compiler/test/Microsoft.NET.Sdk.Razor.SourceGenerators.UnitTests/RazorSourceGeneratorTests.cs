...
#pragma warning restore RS1036 // Specify analyzer banned API enforcement setting
        ...
        public async Task RoslynTokenizerDisabledWithFalseOrNothing(string? value)
        {
            ...
            var result = RunGenerator(compilation!, ref driver,
                // Pages/Index.razor(1,8): error CS1525: Invalid expression term ')'
                Diagnostic(ErrorCode.ERR_InvalidExprTerm, "").WithArguments(")").WithLocation(1, 8));

            result.VerifyPageOutput(
                """"
                #pragma checksum "Pages/Index.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "963ade16932d3478e0c415152236ab20cb3b1cd4"
                // <auto-generated/>
                #pragma warning disable 1591
                namespace MyApp.Pages
                {
                    ...
                    #nullable disable
                    {
                        ...
                        protected override void BuildRenderTree(global::Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder __builder)
                        {
                            __builder.OpenElement(0, "div");
                #nullable restore
                #line (1,8)-(1,8) 24 "Pages/Index.razor"
                __builder.AddContent(1, 
