...
internal class DefaultRazorCSharpLoweringPhase : RazorEnginePhaseBase, IRazorCSharpLoweringPhase
{
        ...
        out RazorCSharpDocument implDocument)
    {
        ...
        // Markup methods move wholesale and a markup property's implementing declaration lands here (its
        // signature stayed in decl). The plan is the same memoized decision the decl phase routed from.
