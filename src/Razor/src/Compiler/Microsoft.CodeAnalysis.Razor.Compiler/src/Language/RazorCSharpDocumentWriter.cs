...
/// <summary>
/// Renders a <see cref="DocumentIntermediateNode"/> tree to a <see cref="RazorCSharpDocument"/>.
/// Owned by neither the impl nor decl C# lowering phase -- both call <see cref="Write"/> with the
/// (possibly mutated) tree they want lowered.
/// </summary>
