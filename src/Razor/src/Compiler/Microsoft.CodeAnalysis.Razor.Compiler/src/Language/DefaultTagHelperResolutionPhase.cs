...
internal partial class DefaultTagHelperResolutionPhase : RazorEnginePhaseBase
{
    ...
    /// marker (Stage 5.0). Used for synthetic empty C# tokens that stand in for a
    /// user-omitted value (e.g. <c>type=""</c> on a bound non-string attribute or
    /// <c>@onclick=""</c>). Stage 5.1's codegen reads the marker to emit a safe
    /// placeholder instead of leaving a hole in the generated C#.
    /// </summary>
