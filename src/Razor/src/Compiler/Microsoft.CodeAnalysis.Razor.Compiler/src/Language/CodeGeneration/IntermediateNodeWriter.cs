...
{
    public static readonly IntermediateNodeWriter Instance = new IntermediateNodeWriter();
    ...
    public virtual void WriteCSharpExpression(CodeRenderingContext context, CSharpExpressionIntermediateNode node)
    {
        ...
        // instead of the actual expression line. See ComponentNodeWriter.WriteCSharpExpression
        ...
        // the approach in ComponentNodeWriter. It is not a perfect mapping, but generally works:
    ...
    protected static void RenderCSharpCode(CodeRenderingContext context, CSharpCodeIntermediateNode node)
    {
        ...
        foreach (var child in node.Children)
        {
            ...
            {
                // Missing-value placeholder tokens are synthetic and must not
                // anchor a source mapping. Without this guard the mapping would
                // widen across the placeholder text and swallow neighbouring
                // user-authored tokens.
