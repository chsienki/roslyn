...
/// parser error-recovery synchronization. Follow sets are language-scoped: an
/// HTML-side set must hold HTML token kinds, a C#-side set must hold C# token
/// kinds. Translation between the two happens at cross-parser handoff sites via
/// <c>RecoveryFollowSets</c> helpers.
/// </summary>
/// <remarks>
...
/// <c>[0, 127]</c>. <see cref="SyntaxKind"/> is a <c>byte</c>-backed enum
/// and <see cref="SyntaxKind.FirstAvailableTokenKind"/> is well below 128;
/// a debug assertion catches a future kind that crosses the 127 boundary.
/// </remarks>
