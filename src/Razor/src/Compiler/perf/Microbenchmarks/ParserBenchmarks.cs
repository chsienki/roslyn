...
// Performance baseline for RazorSyntaxTree.Parse. Inputs are split into
// "well-formed" (regression guard) and "ill-formed" (recovery path --
// naturally slower).
[MemoryDiagnoser]
public class ParserBenchmarks
{
    ...
    // Ill-formed inputs that exercise the path. Each is
    ...
    public void Setup()
    {
        ...
        // Critical correctness check: well-formed inputs must
