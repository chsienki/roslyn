...
///  when the cursor lands inside a <c>SkippedContentSyntax</c> -- the node
///  the enhanced parser produces while synchronizing past an error -- the
...
///  <c>SkippedContentSyntax.OriginatingLanguage</c> (set by
///  <c>Synchronize</c> at the call site -- see Big Design Decision #10
///  in the plan). <see cref="RazorCompletionListProvider.DetermineLanguageKind"/>
...
public class RazorCompletionListProviderRecoveryTest
{
    ...
    public void Completion_InsideHtmlSkippedContent_OffersHtmlCompletions()
    {
        ...
        // `UnnamedTag_EnhancedRecovery` (Stage 3.4) tests, where
