...
internal sealed class SemanticTokensVisitor : SyntaxWalker
{
    ...
    {
        // Tokens the parser absorbed while synchronizing after an error are
        // wrapped in a SkippedContentSyntax. Classify the whole region as a
        // Razor comment so the editor renders it visually distinct from real
        // code/markup -- the user can see "something is wrong here" at a
        // glance, while the accompanying diagnostic explains why.
